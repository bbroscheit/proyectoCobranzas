...
const retiroTemplate = require("../mailModels/retiro");
...
const sendLegales = async (numeroCliente, user, destinatario) => {
  ...
  try {
    ...
    console.error("Error en sendLegales:", error);
    throw error;
  }
};

module.exports = sendLegales;