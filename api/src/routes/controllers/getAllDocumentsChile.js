...
const { GP_USER, GP_PASSWORD, GP_SERVER_CHILE, GP_DATABASE_CHILE } = process.env;

const config = {
    user: GP_USER,
    password:  GP_PASSWORD,
    server: GP_SERVER_CHILE,
    database: GP_DATABASE_CHILE,
    options: {
...
const getAllDocumentsChile = async () => {
  try {
...
module.exports = getAllDocumentsChile;