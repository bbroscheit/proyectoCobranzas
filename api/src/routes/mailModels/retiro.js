  ...
  return `
    <html>
      <body style="font-family: Arial, sans-serif;">
        ...
        <p>Nos dirigimos a usted con carácter de última notificación para informarle que, a la fecha, su cuenta presenta un saldo pendiente por un total de $${Number(facturas.reduce((total, f) => total + f.montopendiente, 0)).toLocaleString("es-AR")}, correspondiente a los servicios brindados por nuestra empresa.</p>
        ...
        <p style="margin-top:20px;">Para evitar este procedimiento, le solicitamos que realice el pago completo de su deuda a la brevedad. Los pagos pueden efectuarse a través de:</p>
        <ul>
          ${cuentasHtml}
