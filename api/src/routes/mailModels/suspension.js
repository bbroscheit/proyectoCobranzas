  ...
  return `
    <html>
      <body style="font-family: Arial, sans-serif;">
        ...
        <p>Le informamos que, debido a la falta de regularización de los pagos pendientes detallados a continuación, los servicios de limpieza asociados a su cuenta han sido suspendidos.</p>
        ...
        <p>Lamentablemente, de no regularizar el saldo pendiente, nos veremos obligados a proceder con el retiro de los equipos en uso.</p>
        <p style="margin-top:20px;">Para evitar esta medida, le solicitamos realizar el pago correspondiente a través de:</p>
        <ul>
          ${cuentasHtml}
