...
function EnvioPreSuspensionModal({ showModal, setShowModal, cliente }) {
  ...
  const onSubmit = (e) => {
    ...
    sendPreSuspension({ numeroCliente: cliente, user, destinatario })
      .then((res) => {
        if (res.state === "success") {
          Swal.fire({ icon: "success", title: "Tu envío fue realizado con éxito!", showConfirmButton: false, timer: 1000 });
        }
